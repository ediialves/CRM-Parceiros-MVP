-- 02_apply.sql
-- Aplica a correcao dos snapshots de 2026-08-21.
...
CREATE TABLE partner_snapshots_bkp_20260821 AS
SELECT * FROM partner_snapshots WHERE imported_at::date='2026-08-21';

BEGIN;

DELETE FROM partner_snapshots WHERE imported_at::date='2026-08-21';
...
SELECT p.id, s.accountancy_id, timestamptz '2026-08-21 12:00:00-03',
...
FROM partner_snapshots WHERE imported_at::date='2026-08-21';
